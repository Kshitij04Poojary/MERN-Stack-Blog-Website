  ...
  return (
    ...
    py-4 ">
        ...
        <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
            ...
            <button onClick={handleLogin} className="w-full px-4 py-4 text-lg font-bold text-white bg-blue-600 rounded-lg hover:drop-shadow-xl">Log In</button>
            {error && <h3 className="text-red-500 text-sm">Something went wrong</h3>}
            <div className="flex justify-center items-center space-x-4">
                <p>New Here?</p>
                <p className="text-blue-400 hover:text-blue-700"><Link to="/register">Register</Link></p>
            </div>
        </div>
    </div>
    <Footer/>
